          ...
          <div class="col-12">
            <div class="card">
                ...
                <div class="card-tools">
                  <div class="input-group input-group-sm">
                    <button
                      ...
                      @click="collectionDetailStore.saveCollection()"
                    >
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-9">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        @keyup.enter="collectionListStore.getListPager"
                        v-model="collectionListStore.filters.keySearch"
                        class="form-control"
                        id="name"
                  ...
                  <div
                    class="form-group"
                    title="Reset bộ lọc"
                    @click="collectionListStore.getListPager(1, 'reset')"
                  >
                    <label>&nbsp;</label>
              ...
              <div class="card-body table-responsive p-0">
                ...
                <LabelText
                  v-else-if="collectionListStore.loading"
                ...
                <LabelText
                  v-else
                  text="Không tìm thấy bộ sưu tập nào"
                  :classAlert="'text-center alert-dismissible'"
                />
              </div>
              <!-- /.card-body -->
